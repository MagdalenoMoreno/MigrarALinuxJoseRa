...
import edu.alumno.adria.api_rest_bd_futbol.exception.CustomErrorResponse;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<CustomErrorResponse> handleCiudadNotFoundException(CiudadNotFoundException ex) {
