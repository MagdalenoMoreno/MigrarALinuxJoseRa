package edu.alumno.adria.dwes_ud3_primer_jpa;
...
import edu.alumno.adria.dwes_ud3_primer_jpa.repository.ModuloRepository;
...
public class DwesUd3PrimerJpaApplication implements CommandLineRunner {
	...
	/*private ModuloDb crearModulo_ConId(){
		...
		ModuloDb nuevoModulo2Db= new ModuloDb(null,"Bases de datos",
		5,"BD");
		return moduloRepository.save(nuevoModulo2Db);
	}*/
